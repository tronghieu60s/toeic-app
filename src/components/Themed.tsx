...
export type ViewProps = ThemeProps & { light?: boolean } & DefaultView['props'];
export type ScrollViewProps = ThemeProps & { light?: boolean } & DefaultScrollView['props'];
